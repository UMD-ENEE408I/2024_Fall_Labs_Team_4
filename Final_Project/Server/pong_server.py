...
PORT = 9925           # Arbitrary non-privileged port (>1024)
...
def handle_client(connection, client_address):
    ...
    try:
        ...
        while game:
            connection.recv(struct.calcsize(format_string))
            _, img = cam.read()
            ...
            packed_data = struct.pack(format_string, robot_num, message.encode('utf-8'))
            print(f"Sending packet: num={robot_num}, text={message}")
